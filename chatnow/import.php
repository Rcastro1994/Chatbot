...
if(isset($_GET['download']) && $_GET['download'] == "yes"){ 
	...
	$url = 'https://www.phpchatbot.com/chatbot/icons.zip';
	...
	if(file_put_contents( $file_name,file_get_contents($url))) {
		...
		// Zip File Name
		if ($zip->open('icons.zip') === TRUE) {

			// Unzip Path
			mkdir('chatnow');
			$zip->extractTo('chatnow/');
			$zip->close();
			echo '<center><h1><img src="https://www.phpchatbot.com/chatnow/images/logo200.png"><br>PHP ChatBot Package Import Tool</h1>Import Process Successful!<br><br><a href="phpMyAdmin" target="_blank">Set up the database</a><br><br>
			<ol>
			</ol>
			</center>';
		} else {
