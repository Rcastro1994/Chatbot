...
function loginForm() {
	...
	<div id="loginform">
	<center>
    <h3>Ingresa tu nombre para continuar!</h3>
...
function addGreeting() {
    ...
    $sayFirst = "Hola " .$_SESSION['identity']->nombre." !";
    $firstMessage = '<li class="out"><div class="chat-img"><img alt="Avatar" src="' . $botAvatar . '"></div><div class="chat-body"><div class="chat-message"><h5>' . $botName . '</h5><p>' . $sayFirst . '<br><small>' . date("g:i A") . '</small></p></div></div></li><hr>';
...
<html lang="en">
    ...
    <body>
        ...
        if (!isset($_SESSION['name'])) {
            ...
            <div class="container-sm content" style="margin-top: 10px;">
                ...
                <form action="" style="margin-top: 10px;">
                    <div class="input-group">
                        <input name="userText" id="userText" autofocus type="text" class="form-control" placeholder="Ingrese su mensaje aquí..." aria-label="Enter your message here..." aria-describedby="basic-addon2">
                        <div class="input-group-append">
                            <button class="btn btn-outline-secondary" type="submit" name="submitmsg" id="submitmsg">Enviar</button>
                        </div>
                    </div>
                </form>
                <!--End Submit Form-->		 
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                $("#submitmsg").click(function () {
                    ...
                    var showLast = '<li class="in"><div class="chat-img"><img alt="Avatar" src="../uploads/images/<?=$_SESSION['identity']->imagen?>"></div><div class="chat-body"><div class="chat-message"><h5><?php echo $_SESSION['name']; ?></h5><p>' + clientmsg + '<br><small>Just now</small></p></div></div></li><hr>';
                ...
                function showTyping() {
                    var typingHTML = '<li class="out"><div class="chat-img"><img alt="Avatar" src="<?php echo $botAvatar; ?>"></div><div class="chat-body"><div class="chat-message"><h5><?php echo $botName; ?></h5><p><center><img src="images/typingnow.gif" style="max-width:50px;""></center></p></div></div></li><hr>';
